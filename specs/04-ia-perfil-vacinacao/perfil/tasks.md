...
> **Status: CONCLUÍDO** (T1–T5, T7, T8 implementados; T6 é P2 opcional, adiado). Ver `specs/design/GAP_ANALYSIS.md` pendências #26.

## [x] T1 — Corrigir texto "Exportar meus dados"
...
## [x] T2 — Criar `healthAppConnectService`
...
## [x] T4 — Adicionar card "Dispositivos conectados"
- Arquivo: `src/screens/ProfileScreen.tsx`
...
## [x] T5 — Conectar "Exportar meus dados" ao `dataExportService`
- Arquivo: `src/screens/ProfileScreen.tsx`
...
## [ ] T6 (P2, opcional — adiado) — Estado de carregamento no card "Dados de saúde"
- Arquivo: `src/screens/ProfileScreen.tsx`
...
## [x] T7 — Validação visual (revisão de código; sem execução visual no dispositivo neste ambiente)
...
## [x] T8 — Atualizar `GAP_ANALYSIS.md` (se necessário)
